# deploy.ps1 — Deploy tikirr.com to TIKI-100 emulator
#
# Copies workbase.dsk to work.dsk, adds tikirr.com, and boots the
...
Write-Host ""
Write-Host "=== TIKI RIVER RAID Deploy ===" -ForegroundColor Cyan
Write-Host ""
